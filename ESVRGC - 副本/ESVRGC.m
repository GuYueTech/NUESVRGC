...
load('E:\hww\ESVRGC\simulation_difflen\10.6RNk3d0.01N1000.mat');
y = XX';

% load('C:\Users\Dell\Desktop\hww\SVR0927\SVR0927\SVR\simulation_difflen\realization_linear_4096.mat');
% y = data';
%load('C:\Users\Dell\Desktop\hww\SVR0927\SVR0927\SVR\y2.mat');
stdData = zscore(y);
