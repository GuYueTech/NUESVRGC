function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,Y,TY] = esvr(TrainingData_File, TestingData_File, NumberofHiddenNeurons, ActivationFunction,C)
